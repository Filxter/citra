...
void GMainWindow::OnStopVideoDumping() {
    ...
    if (video_dumping_on_start) {
        ...
        connect(dialog, &QDialog::rejected, this,
                [] { Core::System::GetInstance().VideoDumper().AbortProcessing(); });
        dialog->show();
    }
}
